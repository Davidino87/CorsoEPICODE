...
*/
// faccio uno switch e verifico il valore di crewMass in quale case finisce utilizzando ParseInt

const totalMass = parseInt(crewMass); // qui qualcosa non mi torna  ???
...
switch (true) {
  ...
  case totalMass > 1000:
    ...
    break;
  default:
    console.log("Mass not within defined ranges");
}
